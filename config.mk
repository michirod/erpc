...
liberpc_portmapper_srcs := $(wildcard ${mkfile_path}portmapper_server/*)
liberpc_out := ${TARGET_OUTPUT_ROOT}/lib/liberpc.a
liberpc_includes := ${TARGET_OUTPUT_ROOT}/include/erpc
liberpc_srcs := $(wildcard ${mkfile_path}erpc_c/*/*.cpp) $(wildcard ${mkfile_path}ercp_c/*/*.h)
...
${liberpc_portmapper}: ${liberpc_portmapper_srcs} ${liberpc_out} ${liberpc_srcs}
	rm -f $@
